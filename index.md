...
> Обновлено: 2026-06-16 | Всего страниц: 43
...
- [[Baku-Metro-Phase-I]] — Baku Metro Phase I (Approved, USD 212.4M)
- [[Baku-Metro-Phase-II]] — Baku Metro Phase II (Proposed, ~USD 826.6M)
- [[exchange-extended-protection]] — Exchange Extended Protection: настройка, состояние
- [[exchange-iis-headers]] — Управление HTTP-заголовками Exchange через IIS URL Rewrite
...
- [[monitoring/index|Мониторинг — сводка]] — все активные мониторинги
- [[UNGM Parser]] — мониторинг тендеров ООН (строительство)
- [[monitoring/stargate-log-monitor]] — Stargate Log Monitor: мониторинг лога Nextcloud (каждые 2 часа)
- [[Парсер тендеров UNGM AIIB]] — Парсер тендеров UNGM/AIIB (Python)
...
- [[cloud.ca-ibm.org-2026-05-21]] — Let's Encrypt сертификат cloud.ca-ibm.org

## SQL

- [[cai-it-inv-w]] — SQL-запрос инвентаризации ИТ
