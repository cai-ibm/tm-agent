...
## [2026-07-01] check | Ежедневная синхронизация — мониторинг расширен
- Проверены сессии за последние 48 часов (30 июня — 1 июля)
- Сессии: Grafana настройка (Coolify Docker Engine metrics, MSSQL дашборд), drawDB проверка
- Memory: недоступна в cron-окружении
- Обновлена страница [[entities/192-168-2-34-hermes-host]]:
  - Добавлен хост `coolify` (192.168.2.39) в мониторинг — 4 хоста, 52 контейнера
  - Добавлен дашборд MS SQL Server (UID: abstn5)
  - updated → 2026-07-01
- Обновлена страница [[entities/192-168-2-39-coolify-wordpress]]:
  - Добавлен раздел Docker Engine Metrics (порт 9323, Prometheus job)
  - updated → 2026-07-01
- Обновлена страница [[entities/drawdb-ca-ibm-org]]:
  - Исправлена ссылка на сервер: server-94-130-51-161 → hz-host1 (192.168.2.37)
  - Исправлены битые [[wikilinks]] (server-94-130-51-161 удалён)
  - updated → 2026-07-01
- Обновлена страница [[серверы/eu-e1c-ca-ibm-org]]:
  - Добавлен раздел «Мониторинг MS SQL Server» (Grafana дашборд, 31 метрика)
  - updated → 2026-07-01
- Обновлена страница [[monitoring/index]]:
  - Добавлена строка MS SQL Server (eu-e1c) в таблицу мониторингов
  - updated → 2026-07-01
- Обновлён [[index.md]]: дата изменена
- Других изменений инфраструктуры не обнаружено


## [2026-07-02] check | Ежедневная синхронизация — обновления: KVM uptime fix, docker-exporter cgroup v2, Grafana State filter
- Проверены сессии за последние 48 часов (1-2 июля)
- Memory: недоступна в cron-окружении
- Обновлена страница [[Инвентаризация/cai-main-b2-tm]]:
  - Добавлен раздел «KVM Exporter (uptime fix)» — исправлен расчёт uptime через PID qemu-процесса
  - updated → 2026-07-02
- Обновлена страница [[entities/192-168-2-37-hz-host1]]:
  - Добавлен раздел «Docker Exporter (cgroup v2 fix)» — исправлен working set memory (5.4→1.61 GiB)
  - updated → 2026-07-02
- Обновлена страница [[entities/192-168-2-34-hermes-host]]:
  - Добавлен дашборд «Контейнеры — Мониторинг» (UID: a47xgn) с фильтром State
  - updated → 2026-07-02
- Обновлён [[index.md]]: дата изменена
- Источники: сессии 2026-07-01 (docker-exporter fix, Grafana dashboard), 2026-07-02 (KVM uptime fix)
- Других изменений инфраструктуры не обнаружено (Ruslan OS v2 — исследование, не развёрнуто; Cursor — обсуждение, не инфраструктура)
