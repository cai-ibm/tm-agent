...
- Обновлена страница [[ht2-vpn-188-124-56-126]]:
...
- Обновлена страница [[ht2-vpn-188-124-56-126]] — добавлен раздел об инциденте, bumped updated
...
- Обновлена страница [[ht2-vpn-188-124-56-126]]:
  ...
  - updated → 2026-06-28
- Создана страница [[dc-192-168-2-2]] — Domain Controller (192.168.2.2, домен cai)
...
- Обновлена страница [[ht2-vpn-188-124-56-126]] — добавлен раздел о перезагрузке 29.06, bumped updated
- Других изменений инфраструктуры не обнаружено
...
- Созданы страницы 4 основных хостов с присвоением имён:
  ...
  - [[hz-host2-192-168-2-39]] — hz-host2 (Coolify)
