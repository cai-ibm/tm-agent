...
⚠️ **ОТКАТ** (15.05.2026) — outbound URL-правила ломают логин в OWA (404 после ввода учётных данных).
Точная причина не выявлена — curl-тесты работают, но в браузере 404.
Скрытие заголовков через outbound server variable rules также откачено.

На момент отката: все правила удалены, Exchange в исходном состоянии.
