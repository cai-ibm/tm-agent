...
- **24.05.2026 18:43** — **Сертификат обновлён и активирован.** Wildcard `*.ca-ibm.org` (истекал 14.06.2026) заменён на `CN=mail.ca-ibm.org` (SAN: autodiscover.ca-ibm.org, webmail.ca-ibm.org). Thumbprint `F5BCE4...`, истекает 22.08.2026. Активирован на **IIS, SMTP, IMAP, POP**. Сертификат перенесён из WebHosting в My (Exchange не видит WebHosting). Создан Scheduled Task «Exchange Certificate Renew» (SYSTEM, пятницы 23:00) — включает NAT:80 на MikroTik → `wacs.exe --renew` → отключает NAT. Скрипт: [[exchange-cert-renew-script]].
...
## Связанные страницы
- [[monitoring/index|Мониторинг]]
- [[eu-e1c-ca-ibm-org]]
- [[188-124-56-126]]
- [[pki-ca-ibm-org]]

- [[dag01-recovery-2026-05-18]]
